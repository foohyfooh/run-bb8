...
gamepad.init();
let description = gamepad.deviceAtIndex(0).description;//Assume first controller is correct
cylon.robot({
  connections: {
  ...
  devices: {
    ...
    controller: { driver: "joystick", config: __dirname + "/logitech-f310-windows.json", description: description, connection: 'joystick'}
  },
